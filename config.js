...
(function (root, factory) {
  ...
  const CONFIG = {
    ...
    GLOSSARY: [
      { h: "درجات RFM — أساس التقسيم", items: [
        ["R — الحداثة", "كم مضى على آخر طلب مؤكد للعميل. الأحدث = درجة أعلى."],
        ["F — التكرار", "عدد طلبات العميل المؤكدة. الأكثر تكرارًا = درجة أعلى."],
        ["M — القيمة", "إجمالي إنفاق العميل المؤكد. الأعلى إنفاقًا = درجة أعلى."],
        ["الدرجة 1–5", "يُرتَّب كل مقياس داخل المتجر نفسه إلى خمس شرائح (1 الأدنى، 5 الأعلى)، وتُحسب لكل متجر ولكل نوع عميل على حدة."]
      ]},
      { h: "الشرائح (Segments)", items: [
        ["الأبطال", "حداثة وتكرار/قيمة عالية — أفضل العملاء. كافئهم واطلب الترشيح."],
        ["الأوفياء / أوفياء محتملون", "شراء متكرر جيد — نمِّ قيمتهم بالعروض المكمّلة."],
        ["عملاء جدد", "اشتروا حديثًا لأول مرة — رحّب وادعم أول تجربة."],
        ["معرّضون للخطر / لا يمكن خسارتهم", "كانوا نشطين وبدؤوا يبتعدون — استعدهم بعرض موجّه قبل فقدانهم."],
        ["خاملون / مفقودون", "بعيدون منذ فترة طويلة — إعادة تنشيط منخفضة التكلفة أو استبعادهم من الإنفاق."]
      ]},
      { h: "دورة الحياة والحالة", items: [
        ["جدد / أساسيون / متراجعون / منسحبون", "مرحلة العميل: أول طلب حديث ← متكرر نشط ← بدأ يهدأ ← تجاوز نافذة الهدوء."],
        ["نشط / معرّض للخطر / منسحب", "حسب قِدَم آخر طلب (نوافذ زمنية قابلة للضبط، وأوسع لعملاء الشركات)."]
      ]},
      { h: "نوع العميل", items: [
        ["شركات (B2B)", "لديه رقم ضريبي/اسم منشأة على أي طلب، أو متوسط طلب مرتفع. يُقاس ضمن مجموعة الشركات فقط."],
        ["أفراد (B2C)", "المستهلك النهائي. يُقاس ضمن مجموعة الأفراد فقط — حتى تكون المقارنة عادلة."]
      ]},
      { h: "المبيعات والطلبات", items: [
        ["مؤكدة", "طلبات مدفوعة/قيد التنفيذ — تُحتسب في المبيعات وRFM."],
        ["ملغاة/مرتجعة", "تُستبعد من المبيعات وتُعرض كعدد منفصل."],
        ["بانتظار الدفع", "لم تكتمل — تُستبعد من المبيعات."],
        ["عملاء جدد", "من سجّلوا حساباتهم خلال الفترة المختارة."]
      ]},
      { h: "السلال والمدفوعات الفاشلة", items: [
        ["السلال المتروكة", "سلات لعملاء مسجّلين لم تتحوّل إلى طلب (آخر 28 يومًا) — قابلة للاسترداد."],
        ["المدفوعات الفاشلة", "محاولات دفع ملغية لم تكتمل، مع طريقة الدفع وعدد المحاولات لكل عميل — أولوية تواصل لاسترداد المبيعة."]
      ]},
      { h: "رحلة العميل عبر المتاجر", items: [
        ["الفكرة", "المتاجر الثلاثة تمثّل مراحل المشروع: مواد البناء ← الإضاءة ← التشطيب. نطابق العميل عبر المتاجر برقم جوّال مُجزّأ (مشفّر، دون حفظ الجوال)."],
        ["الاستخدام", "نعرف مرحلة كل عميل، ومن انتقل ومن توقّف، ونوصّي بالمتجر/المنتجات التالية — مع قوائم عملاء قابلة للتنفيذ."]
      ]},
      { h: "الفترة الزمنية", items: [
        ["الفلتر", "يتحكّم بكل أرقام المبيعات والتصنيفات والتوزيع الجغرافي. الافتراضي: آخر سنة."],
        ["لقطة العملاء", "الشرائح ودورة الحياة تعكس الوضع الحالي ولا تتغيّر بالفلتر (لأنها لحظية بطبيعتها)."]
      ]}
    ],
    ...
    UI: {
      ...
      failed: {
        ...
        value: "إجمالي القيمة الفاشلة",
        cols: { customer: "العميل", value: "إجمالي القيمة", attempts: "المحاولات", method: "آخر طريقة دفع", date: "آخر محاولة", salla: "فتح في سلة" },
      ...
      journey2: {
        ...
        coverageNote: "تعتمد المطابقة على وجود رقم جوال؛ العملاء بدون جوال لا تُحتسب. القائمة قابلة للتنفيذ: العميل يُفتح في متجره وفي لوحة سلة.",
